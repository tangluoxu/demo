...
public class V3ToWav {
    ...
    public static File voxConvert(String inFile, String outFile, int voxFormat,
    ...
    public static void main(String[] args) {
        ...
        String inFile  = "E:\\下载的音乐\\1534005.V3";  //输入的文件路径
        String outFile = "E:\\下载的音乐\\1534005.mp3";  //输出的文件路径

        try {
            File file = voxConvert(inFile, null, 1, 6000, 1);
            String path = file.getAbsolutePath();
            System.err.println("path: " + path);
            WavToMP3.execute(file,path.substring(0,path.length()-3)+"mp3");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
